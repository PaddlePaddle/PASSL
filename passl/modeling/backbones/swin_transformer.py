...
__all__ = ["VisionTransformer", "ViT_small_patch16_224"]
...
class SwinTransformer(nn.Layer):
    """ Swin Transformer
        A PASSL implementation of `Swin Transformer: Hierarchical Vision Transformer using Shifted Windows`  -
