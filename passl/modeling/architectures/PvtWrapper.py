...
@MODELS.register()
class PvtWrapper(nn.Layer):
    def __init__(self, architecture=None, head=None):
        """A wrapper for a pvt model as specified in the paper.

        Args:
            architecture (dict): A dictionary containing the pvt instantiation parameters.
        """
        super().__init__()
