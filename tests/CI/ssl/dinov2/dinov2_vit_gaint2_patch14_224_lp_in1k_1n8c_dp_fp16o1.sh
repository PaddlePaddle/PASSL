...
python -m paddle.distributed.launch \
    ...
    passl-train \
    -c ../../tasks/ssl/dinov2/configs/dinov2_vit_gaint2_patch14_224_lp_in1k_1n8c_dp_fp16o1.yaml \
    ...
    -o Global.pretrained_model=./pretrained/dinov2/dinov2_vitg14_pretrain
